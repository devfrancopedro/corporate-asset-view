  ...
  return (
    <div className="min-h-screen bg-black flex w-full">
      ...
      <div className="flex-1 flex flex-col lg:ml-64 min-h-screen">
        ...
        <div className="fixed top-0 right-0 left-0 lg:left-64 z-20 bg-black border-b border-gray-800 safe-area-top">
          <div className="flex items-center lg:hidden px-3 py-2">
            <button
              onClick={() => setSidebarOpen(true)}
              className="p-2 rounded-2xl text-white hover:bg-gray-900 touch-target"
            >
              <Menu size={20} />
            </button>
          </div>
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 pt-20 sm:pt-24 lg:pt-28 safe-area-bottom overflow-x-hidden bg-black">
